function c = cluster(points, numclusters, distance_string, display_string)
...
hold off
scatter(points(1,1), points(1,2),5,[0,0,0]);
hold on;
...
for i=1:size(clusters, 2)
  ...
  for j=1:length(ci)
      scatter(points(ci(j),1),points(ci(j),2), 50, cluster_colour);
  end
end
